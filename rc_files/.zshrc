...
export KAFKA_HOME='/Users/peter_v/Documents/programs/kafka/kafka_current_version'
...
export PATH=$PATH:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/sbin:/opt/X11/bin:$GRADLE_HOME/bin
